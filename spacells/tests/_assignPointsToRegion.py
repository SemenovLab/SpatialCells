...
def assignPointsToRegion(anndata, boundary, assigncolumn="region", target="target", donelist=[]):
    ...
    nGrid = 10
    xv, yv, grid_label = getGrid(x_min, x_max, y_min, y_max, nGrid, boundary)
    assignRegion(xv, yv, grid_label, assigncolumn, target, boundary, anndata, donelist, nGrid = nGrid)
